...
class Ajax extends CI_Controller {
    ...
    public function loadhours($fecha, $customer){
        $singleCliente = $this->clientes_model->get_clientes_single($customer);
        $data['customerName'] = $singleCliente[0]['cliente'];
        ...
        $dateFrom = $fecha . "-01";
        $nextDate = $fecha . "-31";
        $data['horas'] = $this->hours_model->get_hours($dateFrom, $nextDate, $customer);
